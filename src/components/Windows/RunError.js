...
function RunError({openRun, close, term}) {
    const confirm = () => {
        openRun()
        close()
    }
    ...
    return (
        <div className="run-error">
            <div className="run-error-container">
                ...
                <div className="run-error-prompt">Cannot find the file '{term}' (or one of its components). Make sure the path and filename are correct and that all required libraries are available.</div>
            </div>
